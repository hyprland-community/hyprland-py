...
# This file was auto-generated by `tools/wiki.py` on 2023-10-05T22:24:18.395009
from .keyword import (
    KeywordBool,
    KeywordColor,
    KeywordFloat,
...
class Touchdevice:
    transform = KeywordInt("input:touchdevice:transform")
    ...
    output = KeywordStr("input:touchdevice:output")
    "the output to bind touch devices. Empty means unset and will use the current / autodetected."


class Touchpad:
    disable_while_typing = KeywordBool("input:touchpad:disable_while_typing")
    "Disable the touchpad while typing."
    natural_scroll = KeywordBool("input:touchpad:natural_scroll")
    "Inverts scrolling direction. When enabled, scrolling moves content directly instead of manipulating a scrollbar."
    scroll_factor = KeywordFloat("input:touchpad:scroll_factor")
    "Multiplier applied to the amount of scroll movement."
    middle_button_emulation = KeywordBool("input:touchpad:middle_button_emulation")
    ...
    tap_button_map = KeywordStr("input:touchpad:tap_button_map")
    "Sets the tap button mapping for touchpad button emulation. Can be one of `lrm` (default) or `lmr` (Left, Middle, Right Buttons)."
    clickfinger_behavior = KeywordBool("input:touchpad:clickfinger_behavior")
    ...
    tap_to_click = KeywordBool("input:touchpad:tap-to-click")
    "Tapping on the touchpad with 1, 2, or 3 fingers will send LMB, RMB, and MMB respectively."
    drag_lock = KeywordBool("input:touchpad:drag_lock")
    ...
    tap_and_drag = KeywordBool("input:touchpad:tap-and-drag")
...
class Blur:
    enabled = KeywordBool("decoration:blur:enabled")
    "enable animations"
    size = KeywordInt("decoration:blur:size")
    "blur size (distance)"
    passes = KeywordInt("decoration:blur:passes")
    "the amount of passes to perform"
    ignore_opacity = KeywordBool("decoration:blur:ignore_opacity")
    "make the blur layer ignore the opacity of the window"
    new_optimizations = KeywordBool("decoration:blur:new_optimizations")
    "whether to enable further optimizations to the blur. Recommended to leave on, as it will massively improve performance."
    xray = KeywordBool("decoration:blur:xray")
    ...
    noise = KeywordFloat("decoration:blur:noise")
    "how much noise to apply. 0.0 - 1.0"
    contrast = KeywordFloat("decoration:blur:contrast")
    "contrast modulation for blur. 0.0 - 2.0"
    brightness = KeywordFloat("decoration:blur:brightness")
    "brightness modulation for blur. 0.0 - 2.0"
    special = KeywordBool("decoration:blur:special")
