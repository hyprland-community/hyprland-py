...
class Defaults:
    ...
    def __init__(self,sock):
        ...
        self.general = General(self.sock)
        self.decoration = Decoration(self.sock)
        self.animations = Animations(self.sock)
        self.input = Input(self.sock)
        self.gestures = Gestures(self.sock)
        self.misc = Misc(self.sock)
        self.binds = Binds(self.sock)
