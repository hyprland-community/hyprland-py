...
from sockets import _command

class General(_command):
...
class Animations(_command):

    enabled = True
    """ enable animations """

class Input(_command):
