...
class Animations(Section):
    _section_name = "Animations"
    _section_map = {"enabled": {"name": "enabled", "description": "enable animations", "type": "bool", "default": "true"}, "first_launch_animation": {"name": "first_launch_animation", "description": "enable first launch animation", "type": "bool", "default": "true"}}
    _section_key = "animations:"
...
class Group(Section):
    _section_name = "Group"
    _section_map = {"insert_after_current": {"name": "insert_after_current", "description": "whether new windows in a group spawn after current or at group tail", "type": "bool", "default": "true"}, "focus_removed_window": {"name": "focus_removed_window", "description": "whether Hyprland should focus on the window that has just been moved out of the group", "type": "bool", "default": "true"}, "col_border_active": {"name": "col.border_active", "description": "active group border color", "type": "gradient", "default": "0x66ffff00"}, "col_border_inactive": {"name": "col.border_inactive", "description": "inactive (out of focus) group border color", "type": "gradient", "default": "0x66777700"}, "col_border_locked_active": {"name": "col.border_locked_active", "description": "active locked group border color", "type": "gradient", "default": "0x66ff5500"}, "col_border_locked_inactive": {"name": "col.border_locked_inactive", "description": "inactive locked group border color", "type": "gradient", "default": "0x66775500"}}
    _section_key = "group:"
...
class Default:
    ...
    touchdevice: Touchdevice = Touchdevice()
    tablet: Tablet = Tablet()
    per_device_input_config: PerDeviceInputConfig = PerDeviceInputConfig()
    gestures: Gestures = Gestures()
    group: Group = Group()
    groupbar: Groupbar = Groupbar()
    misc: Misc = Misc()
    binds: Binds = Binds()
